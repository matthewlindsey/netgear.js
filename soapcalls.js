...
exports.action = {
  ...
  getBlockDeviceEnableStatus:
    "urn:NETGEAR-ROUTER:service:DeviceConfig:1#GetBlockDeviceEnableStatus",
  ...
  setTrafficMeterOptions: "urn:NETGEAR-ROUTER:service:DeviceConfig:1#SetTrafficMeterOptions",
  ...
  get5G1GuestAccessEnabled:
    "urn:NETGEAR-ROUTER:service:WLANConfiguration:1#Get5GGuestAccessEnabled", // 5G-1 R7800
  get5G1GuestAccessEnabled2:
    "urn:NETGEAR-ROUTER:service:WLANConfiguration:1#Get5G1GuestAccessEnabled", // 5G-1 R8000
  get5GGuestAccessEnabled2:
    "urn:NETGEAR-ROUTER:service:WLANConfiguration:1#Get5GGuestAccessEnabled2", // 5G-2 R8000
  ...
  set5G1GuestAccessEnabled:
    "urn:NETGEAR-ROUTER:service:WLANConfiguration:1#Set5GGuestAccessEnabled", // 5G-1 R7800
  set5G1GuestAccessEnabled2:
    "urn:NETGEAR-ROUTER:service:WLANConfiguration:1#Set5G1GuestAccessEnabled2", // 5G-1 R8000
  set5GGuestAccessEnabled2:
    "urn:NETGEAR-ROUTER:service:WLANConfiguration:1#Set5GGuestAccessEnabled2", // 5G-2 R8000
  ...
  getBandwidthControlEnableStatus:
    "urn:NETGEAR-ROUTER:service:DeviceConfig:1#GetBandwidthControlEnableStatus", // ***NEW***
...
exports.setTrafficMeterOptions = (
  sessionId,
  newControlOption,
  newNewMonthlyLimit,
  restartHour,
  ...
  const soapBody = `<v:Body>
		<M1:SetTrafficMeterOptions xmlns:M1="urn:NETGEAR-ROUTER:service:DeviceConfig:1">
			<NewControlOption>${newControlOption}</NewControlOption>
			<NewNewMonthlyLimit>${newNewMonthlyLimit}</NewNewMonthlyLimit>
			<RestartHour>${restartHour}</RestartHour>
			<RestartMinute>${restartMinute}</RestartMinute>
			<RestartDay>${restartDay}</RestartDay>
